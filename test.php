...
$db = mysqli_connect("db1.cs.uakron.edu:3306", "bck25", "AusahL1e");
...
// Select the database
$er = mysqli_select_db($db,"DB_bck25");
if (!$er) {
...
print "<p>The HTML table below is dynamically generated in PHP from records retreieved from the MySQL Database on db1.cs.uakron.edu</p>";
...
print "<table><caption> <h2> Pokémon ($num_rows) </h2> </caption>";
